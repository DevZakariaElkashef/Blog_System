                        ...
                        <div class="p-5">
                            ...
                            <form class="user" method="POST" action="{{ route('register') }}">
                                ...
                                <div class="form-group">
                                    <input type="text" class="form-control form-control-user" id="exampleNamel"
                                        placeholder="Your Name" name="user_name" :value="old('user_name')" required autofocus>
                                </div>
                                <div class="form-group">
