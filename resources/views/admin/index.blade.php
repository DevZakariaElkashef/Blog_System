                ...
                <div
                    ...
                    <div class="dropdown no-arrow">
                        ...
                        <div class="dropdown-menu dropdown-menu-right shadow animated--fade-in"
                            ...
                            <a class="dropdown-item" href="#" class="disabled" aria-disabled="true">Action</a>
                            <a class="dropdown-item" href="#" class="disabled" aria-disabled="true">Another action</a>
                            <div class="dropdown-divider"></div>
                            <a class="dropdown-item" href="#" class="disabled" aria-disabled="true">Something else here</a>
                        </div>
                    </div>
                </div>
                <!-- Card Body -->
